...
public class ReturnOrderPrinter extends BasePrinter{
    private java.util.List<ReturnOrderDto> dtos;

    public ReturnOrderPrinter(List<ReturnOrderDto> dtos){
        this.dtos = dtos;
    }
    @Override
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        ReturnOrderDto dto = dtos.get(this.getIndex());
        Component c = null;
        //转换成Graphics2D
        ...
        switch (pageIndex) {
            case 0:
                ...
                Image src = ImageUtils.imageForURL(dto.getQrCodePath());
                if (src == null) {
                ...
                g2.setFont(font);
                g2.drawString(dto.getDepartment()+"-"+dto.getArea(), (float) 10, start += 20);
