    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        switch (flag) {
            ...
            case 2:
                ...
                g2.setFont(font);
                g2.drawString("日期："+dto.getDate(), (float) 10, start += 16);
                g2.drawString("总回单数："+dto.getTotalTicketNums(), (float) 120, start);
                ...
                rowHeight = 25;rowWidth = 50;
                rows = dto.getList().size()<10?11:dto.getList().size()+1;columns = 4;
                g2.setFont(new Font("新宋体", Font.PLAIN, 10));
                tableX = 10;tableY = (int) (start+10);
                double[] rate2 = {0.5d,1d,1d,1d};
                DrawUtils.drawTable(g2,tableX,tableY,rows,columns,rowWidth,rowHeight,rate2);
                        ...
                        if (i == 0){
                            ...
                            switch (j){
                                ...
                                case 2:
                                    msg = dto.getList().get(i-1).getTicketNums()+"";break;
                                case 3:
                                    msg = dto.getList().get(i-1).getDesc()+"";break;
                            }
                        }
                        int diff = 15;
                        if (j > 0){
                            diff = tableX+(j*(int)(rowWidth*rate2[j-1]))+5;
                        }
                        g2.drawString(msg+"",diff,y1-10);
                    }
                }
